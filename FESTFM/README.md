...
In this section, we mainly introduce how to reproduce our model. If needed, you can reproduce our results based on our prompts. However, due to inconsistencies in results generated by different devices and environments, we cannot guarantee that you will be able to fully replicate our results, but it can serve as a reference for the robustness of our code. We encourage you to apply our code to other stress-related datasets and hope you can share the results with us.

### Environment Configuration

Our proposed model is implemented using:
- **Python**: 3.8.0
- **PyTorch**: 1.8.0
- **OS**: Windows 10
- **CPU**: Intel i9-14900K 3.2GHz
- **RAM**: 128GB
...
# Build graph from raw signals
graph_data = build_graph_data(
    signal_matrix=signal_matrix,
    fs=fs,
    target_dim=14,       # Align with FE-GAT input dimensions
    mi_threshold=0.15,   # Mutual Information threshold (suggest 0.1-0.3)
    device='cpu'         # or 'cuda'
)
